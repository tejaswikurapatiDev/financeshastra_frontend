...
function Forgetpassworddarkmode() {
  ...
  const handleSubmit = (e) => {
    ...
    // If validations pass, clear the error and navigate or call API
    setEmailError("");
    console.log("Form submitted with email:", email);
    navigate("/openemaildarkmode");
  };
  ...
  return (
    <div className="login-containerdarkmode">
      <div className="login-leftforgetdarkmode">
        <img src={logoimg} className="logoforgtdarkmode" alt="Logo" />
      </div>
      <div className="login-rightdarkmode">
        <div className="login-boxforgetdarkmode">
          ...
          <p className="paraforgotdarkmode">
            No worries! Enter your email address below and we’ll<br />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button 
              type="submit"
              className={`sign-in-btndarkmode ${email ? "active" : "inactive"}`}
            >
              Submit
            </button>
          </form>
          <p className="paragraphforgettdarkmode">
            Remember password?{" "}
            <strong
              className="loginparadarkmode"
              style={{ color: "#24b676", cursor: "pointer" }}
              onClick={() => navigate("/logindarkmode")}
            >
              Login instead!
            </strong>
          </p>
