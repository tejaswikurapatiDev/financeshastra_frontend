...
const Landingdarknavbar = () => {
  ...
  return (
    <>
      <nav className="darkmodenavbar">
        <div className="navbar-logo">
          <img src={logo} alt="FinanceShastra Logo" className="logo-darkimage" />
        </div>
        ...
        <div className="navbar-darksearch">
          ...
          <FaSearch className="searchdarkicon" style={{ color: "white" }} />
...
export default Landingdarknavbar;