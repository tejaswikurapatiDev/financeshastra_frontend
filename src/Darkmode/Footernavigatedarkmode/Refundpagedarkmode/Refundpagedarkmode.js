...
const RefundPolicydarkmode = () => {
  return (
 
    <div className="refundpolicyydarkmode">
      <h1>Cancellation and Refund Policy</h1>
      <p className="refundpolicyy-lastupdateddarkmode">
        <FaRegCalendar className="calenderrefundicondarkmode" /> Last updated: 08 Dec 2024{" "}
        <LuDot className="dotrefund" />
      </p>
      <img src={refundImage} alt="Cancellation and Refund" className="refundpolicyy-imagedarkmode" />
      <div className="refundpolicyy-headerdarkmode">
      ...
      <div className="refundpolicyy-sectiondarkmode">
      ...
      <p className="refundpolicyy-contactdarkmode">
...
export default RefundPolicydarkmode;
