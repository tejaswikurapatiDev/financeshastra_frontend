...
const Disclaimerdarkmode = () => {
  return (

    <div className="disclaimerdarkmode">
      <h1 className="disclaimer-titledarkmode">FinanceShastra Disclaimer</h1>
      <img src={disclaimerImage} alt="Disclaimer" className="disclaimer-imagedarkmode" />
      <div className="disclaimer-introdarkmode">
      ...
      <div className="disclaimer-sectiondarkmode">
        <h2>I. General</h2>
        <p>
...
This Disclaimer constitutes the entire agreement between FinanceShastra and the user concerning the subject matter and supersedes all prior agreements. 
      ...
      <div className="disclaimer-contactdarkmode">
...
export default Disclaimerdarkmode;
