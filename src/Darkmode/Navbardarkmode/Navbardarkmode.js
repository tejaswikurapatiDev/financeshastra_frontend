...
const Navbardarkmode = () => {
  ...
  const renderStockDropdown = () => (
    <div className="stockmenudarkerrrrmode">
  ...
  const renderPortfolioDropdown = () => (
    <div className="learn-menudarkerrrrmode">
      <div className="dropdown-item">
        <Link to="/portfolio">My Portfolio
          <p>Your financial navigator</p>
        </Link>
      </div>
      <div className="dropdown-itemdarkerrmode">
  ...
  const renderUserDropdown = () => (
    <div className="user-menudarkerrmode">
       <div className="dropdown-itemdarkerrmode">
        <Link to="/userDetailsupdate"><FaUser className="dropdown-icondarkerrrmode" />
          My Profile</Link>
      </div>
      <div className="dropdown-itemdarkerrmode">
        <Link to="/help"><FaCircleQuestion className="dropdown-icondarkerrrmode" />
          Help Center</Link>
      </div>
      <div className="dropdown-itemdarkerrmode">
        <Link to="/"> <FaUserCircle className="dropdown-icondarkerrrmode" />
          Logout</Link>
      </div>
    </div>
  );
  ...
  const renderMutualFundsDropdown = () => (
    <div className="mutualstockmenudarkerrrrmode">
      <div className="stockmenu-column">
        <ul>
          <li>
            <div className="dropdown-item">
  ...
  return (
    <>
      <nav className="navbardarkerrrrmode">
        <div className="navbar-logo">
          <img src={logo} alt="FinanceShastra Logo" className="logo-image" />
        </div>

        <ul className="navbar-linksdarkerrrrmode">
        ...
        <div className="navbar-darksearch">
          <input type="text" placeholder="Search for Stocks, Mutual..."/>
          <FaSearch className="searchdarkerrrmodeicon" style={{ color: "white" }} />
        </div>
        ...
        <div className="navbar-icons">
         <div className="notificationall">
              {/* Bell Icon */}
              <FaBell className="icon bell-darkerrmodeicon" onClick={() => setIsOpen(!isOpen)} />
          ...
          <div className="profile-section">
            <li className="" ref={userDropdownRef} >
              <Link to="#" onClick={toggleUserDropdown}>
                <FaUserCircle className="iconuser-darkerrmodeicon" />
