...
import './Homestockanalystdarkmode.css';
import { useNavigate } from "react-router-dom";
import Cookies from "js-cookie";

const  Homestockanalystdark = () => {
  ...
  return (
    ...
    <div>
      <div className="screener-containerr">
        {/* Tabs */}
        <div className="tabsnifty50-containerdashdarkmode">
  {["All", "Gainers", "Losers", "LTP", "Change %", "Market Cap", "ROE", "P/E", "P/BV", "EV/EBITDA", "5Y Sales Gr", "5Y Profit Gr"].map((tab) => (
    <button
      key={tab}
      className={`tabnifty50-buttondashdarkmode ${activeTab === tab ? "active" : ""}`}
...
export default Homestockanalystdark;