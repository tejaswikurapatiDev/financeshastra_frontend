...
import './Stockcalenderdarkmode.css'
        ...
        <div className="earnings-insight-learn-wrapperr">
            ...
            <div className="earnings-insight-learn-controls">
                <div className="earnings-insight-learn-header-row">
                    <div className="earningquterlyrowallldarkmode">
...
<div >
            ...
            <table className="DashboardMainPagetable-tableedarkmode">
                <thead>
                    <tr>
...
export default Stockcalenderdarkmode