...
import "./Watchlistdashboardmaindarkmode.css";
...
const Watchlistdashboardmaindarkmode = () => {
  ...
  return (
    <div className="Watchlistdashboardmain-containerdarkmode">
        ...
        {watchlistdashboardmainData.map((item) => (
          <li key={item.id} className="Watchlistdashboardmain-item">
            ...
            <div className="Watchlistdashboardmain-info">
              <p className="Watchlistdashboardmain-namedarkmode">{item.name}</p>
            </div>
...
export default Watchlistdashboardmaindarkmode;