...
const PortfolioAnalysisSpeedometer = () => {
  ...
  const ratings = [
    { label: "Strong Sell", angle: 170, x: -50, y: 90 },
    { label: "Sell", angle: 125, x: 10, y: 20 },
    { label: "Neutral", angle: 90, x: 85, y: -3 },
    { label: "Buy", angle: 45, x: 170, y: 20 },
    { label: "Strong Buy", angle: 10, x: 200, y: 90 },
  ];
