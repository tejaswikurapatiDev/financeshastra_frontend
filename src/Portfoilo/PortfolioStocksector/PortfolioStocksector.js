...
import "./PortfolioStocksector.css"; // Assuming your styles are in this file
...
const PortfolioStocksector = () => {
  ...
  return (
    ...
    <td className="stock-name">
      Telecommunication - <br/>Equipment
    </td>
    <td></td>
...
export default PortfolioStocksector; 
