...
const BillingDetailsPageannually = () => {
...
<div className="profilepage-tabsorderusers" >
    ...
    >
      ...
      <div className="toggle-switch-container">
        <button className="toggle-button"  onClick={() => navigate("/billingSubscriptionPages")} >Half yearly</button>
     
      <button className="toggle-button active" onClick={() => navigate("/billingDetailsPageannually")}>Annually</button>
    </div>
...
export default BillingDetailsPageannually;