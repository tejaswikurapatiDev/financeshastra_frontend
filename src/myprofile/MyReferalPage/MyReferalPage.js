    ...
    <div className="profilepageee-container">
      ...
      <div className="myreferalpagesss">
        ...
        <section className="myreferalpagesss-why-refer">
          <h2 className="myreferalpagesss-why-referh2">
            Why Refer to FinanceShastra?
          </h2>
          <div className="myreferalpagesss-why-refer-content">
            <div className="myreferalpagesss-why-refer-text">
              <p>
                You want to help your loved ones overcome their investment{" "}
                <br />
                challenges, but guiding them can feel overwhelming.
              </p>
              <ul>
                <li>
                  They lack a reliable way to secure their financial future.
                </li>
                <li>
                  They’re making mistakes you’ve already learned to avoid.
                </li>
              </ul>
              <p>
                FinanceShastra offers a proven path to financial freedom, and as
                a <br />
                partner, you can support their journey confidently while earning{" "}
                <br /> valuable rewards.
              </p>
            </div>
        ...
        <section className="myreferalpagesss-partner-benefits">
          <h2 className="myreferalpagesss-partner-benefitsheader">
            What Do You Gain as a FinanceShastra Partner?
          </h2>
          <div className="myreferalpagesss-partner-benefitscontent">
            ...
            <div className="myreferalpagesss-partner-benefitstext-section">
              <h3 className="myreferalpagesss-partner-benefitstext-sectionh3">
                We aim to make your partnership with us both rewarding and
                empowering: 
              </h3>
              <h3 className="myreferalpagesss-partner-benefitstext-sectionh3">
                1. Revenue Sharing:
              ...
              <ul>
                ...
                <li>
                  Refer 9 successful investors to become a Lifelong Partner.
                </li>
                <li>Lifelong Partners earn:</li>
                <ul>
                  <li>15% of first-year fees.</li>
                  <li>
                    10% of renewal fees every year thereafter (excluding GST).
                  </li>
                </ul>
              </ul>
              <h3 className="myreferalpagesss-partner-benefitstext-sectionh3">
              ...
              <ul>
                <li>
                  Recognition as a key contributor to FinanceShastra’s Mission
                  Financial Freedom.
                </li>
                <li>
                  Access to premium resources to elevate your investment
                  knowledge.
                </li>
              </ul>
              <button
            ...
            <div className="how-to-refer-text">
              <ul>
                ...
                <ol>
                  ...
                  <li>
                    We’ll send them a <strong>FREE copy</strong> of the book:{" "}
                    <br />
                    <strong>
                      Rich Dad Poor Dad -{" "}
                      <em>by Robert T. Kiyosaki (Author)</em>
                    </strong>
                  </li>
                  <li>
                    Our team will contact them to confirm interest and start
                    their investment journey.
                  </li>
                </ol>
                <li>
                  By referring your network, you help us create a wealthier and
                  more secure India.
                </li>
              </ul>
            </div>
        ...
        <h2 className="why-financeshastra-header">
          Why <span>FinanceShastra?</span>
        </h2>
        <section className="why-financeshastra-section">
          <div className="why-financeshastra-content">
            ...
            <div className="why-financeshastra-text">
              <p>
                India's growing economy provides an incredible opportunity for
                equity investments. FinanceShastra is dedicated to helping
                millions of Indians <br />
                achieve financial independence by investing wisely.
              </p>
              <button
        ...
        <section className="referral-criteria-section">
          <div className="referral-criteria-content">
            ...
            <ul>
              ...
              <li>
                Rewards are updated in real time and paid on the 15th of each
                month if they exceed ₹5,000.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                Employees of FinanceShastra are ineligible for referral
                benefits.
              </li>
              <li>
            ...
            <p>
              Let’s make financial freedom a reality for millions. Together, we
              can create a brighter financial future.
            </p>
            <button
