...
import './Goalplannersubscribe.css'

const Goalplannersubscribe = () => {
  ...
  return (
    <div>
      ...
      <div className="subscription-containerr">
    


      <div className="plans-wrappergoal">
        {/* Elite Plan */}
        <div className="plan-cardelite-plangoalcalcu">
        <div className="plan-headergoalcalcu">
  <div className="plan-header-contentgoalcalcu">
    <h2 className="plan-header-titleelitegoalcalcu">Elite</h2>
  
    <p className="plan-descriptioncal">Empower your investment journey with the Elite Plan!</p>
  

             
            <div className="ribbon-priceeecal">
  <span className="price-valuee" >₹2,000</span> 
  <span className="price-valuemonth"> / 6 Month</span>
  <span className="ribbon-price-detailcalc">   ₹999 / After 6 Month</span>
...
<button className="pay-now-btncalinvestgoal" onClick={() => navigate('/halfyearlySubscriptionPages')}>
           Subscribe
        </button>
</div>
...
<div className="most-popular-containercalculategoall">
  <h2 className="most-popular-text">Most Popular!</h2>


{/* Premium Plan */}
<div className="plan-cardpermium-plancalcgoal">
  <div className="plan-headercalll">
    <div className="plan-header-contentcalll">
      <h2 className="plan-header-titleecaaa">Premium</h2>
      <p className="plan-description">
        Invest smarter, invest confidently with the Premium Plan!
      </p>
      <div className="ribbon-priceecal">
        <span className="price-valuee">₹5,999</span>
        <span className="price-valuemonth"> / 6 Month</span>
        <span className="ribbon-price-detailcalc">₹2,000 / After 6 Month</span>
        <div className="text-blackcal">
          You save
      ...
      <button
        className="pay-now-btnfooterrcal"
...
export default Goalplannersubscribe;