...
import holidayimg from "../../assest/holiday.png";
import tripimg from "../../assest/trip.png"; 
import Navbar from "../../Navbar/Navbar";
import FooterForAllPage from "../../FooterForAllPage/FooterForAllPage";
import { IoChevronBackSharp } from "react-icons/io5";
import { useNavigate } from "react-router-dom";
import './HolidayGoalPlanner.css'


const HolidayGoalPlanner = () => {
...
const calculateMonthlyAmount = (goalCost, inflationRate, returnRate, tenure) => {
  ...
  return (
    <div>
      ...
      <h1 className="goalplanner-titleallcar">Holidays</h1>

      <div className="goalplanner-container">
        <div className="goalplanner-left">
          <h1 className="goalplanner-title">Holidays</h1>
          <div className="goalplanner-image-container">
            <img src={holidayimg} alt="House Illustration" className="goalplanner-image" />
          </div>
        ...
        <div className="goalplanner-right">
          <div className="goalplanner-slider-group">
              <div className="goalplanner-image-containerrr">
                      ...
                      <img src={tripimg} alt="Car Illustration" className="goalplanner-imageholiday" />
                    </div>
...
export default HolidayGoalPlanner;
