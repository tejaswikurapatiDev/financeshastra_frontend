...
import weddingimg from "../../assest/wedding.png";
import coupleimg from "../../assest/couple.png"; 
...
const calculateMonthlyAmount = (goalCost, inflationRate, returnRate, tenure) => {
  ...
  return (
    <div>
      ...
      <h1 className="goalplanner-titleallcar">Wedding</h1>

      <div className="goalplanner-container">
        <div className="goalplanner-left">
          <h1 className="goalplanner-title">Wedding</h1>
          <div className="goalplanner-image-container">
            <img src={weddingimg} alt="House Illustration" className="goalplanner-image" />
          </div>
        ...
        <div className="goalplanner-right">
          <div className="goalplanner-slider-group">
              <div className="goalplanner-image-containerrr">
                      ...
                      <img src={coupleimg} alt="Car Illustration" className="goalplanner-imageholiday" />
                    </div>
...
export default WeddingGoalPlanner;
