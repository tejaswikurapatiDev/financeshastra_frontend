...
import './Electronicgoalplanner.css'



const ElectronicGoalPlanner = () => {
...
const calculateMonthlyAmount = (goalCost, inflationRate, returnRate, tenure) => {
  ...
  return (
    <div>
      ...
      <h1 className="goalplanner-titleallelectronic">Electronic Gadgets</h1>

      <div className="goalplanner-container">
        <div className="goalplanner-left">
          <h1 className="goalplanner-title">Electronic Gadgets</h1>
          <div className="goalplanner-image-container">
            <img src={wateringplantimg} alt="House Illustration" className="goalplanner-imagewater" />
          </div>
        ...
        <div className="goalplanner-right">
          <div className="goalplanner-slider-group">
              <div className="goalplanner-image-containerrr">
                      ...
                      <img src={plantimg} alt="Car Illustration" className="goalplanner-imageholiday" />
                    </div>
...
export default ElectronicGoalPlanner;
