...
function Forgetpassword() {
    ...
    <div className="login-container">
      ...
      <div className="login-right">
        <div className="login-boxforget">
          ...
          <p className="paraforgot">No worries! Enter your email address below and we’ll<br/>
  ...
  <div className="input-container">
    ...
    />
    {emailError && <span className="forgeterror-text">{emailError}</span>}
  </div>
  ...
  >
    Submit
         ...
         <p className="paragraphforgett">Remember password ? <strong style={{color:"#0349A8",cursor:"pointer"}}  onClick={() => navigate("/login")}>Login instead!</strong></p>
