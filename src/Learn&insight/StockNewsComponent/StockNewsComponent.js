  ...
  const newsArticles = [
    {
      ...
      description:
        "Gland Pharma Share Price | The company expects to launch this product through its marketing partners in the near future.",
    ...
    },
    {
      ...
      description:
        "Acme Solar Holdings Share Price | With this project, company's total capacity now stands at 8,750 MW.",
      image: img2,
    },
    {
      id: 3,
    ...
    },
    {
      id: 5,
      title:
        "Trade Spotlight: How should you trade HDFC AMC, Tata Communications, Lemon Tree Hotels, KRBL, PCBL, IRCTC, and others on Thursday?",
      description:
        "The consolidation is likely to continue until the benchmark indices decisively break the tight range of the past four days.",
      image: img5,
    },
    {
      id: 6,
      title:
        "Stock Radar: Nuvama Wealth, Acme Solar, Reliance Power, Varroc Engineering, Strides Pharma, Waaree Energies, Shriram Finance in focus on Thursday",
    ...
    },
    {
      ...
      description:
        "Promoter group company PEAK XV Partners Investments V sold shares in Awfis Space Solutions at Rs 709.9.",
      image: img7,
    },
    {
      id: 8,
      title:
        "Technical View: Nifty closes above 24,600 in rangebound session; crucial support lies at 24,500",
    ...
    },
    {
      ...
      description:
        "Indian conglomerate Adani Group has engaged in a brazen stock manipulation and accounting fraud scheme.",
      image: img9,
    },
  ];
