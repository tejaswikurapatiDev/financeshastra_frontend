...
const data = {
  ...
  "1M": [
    ...
    { x: new Date(1538809200000), y: [6614.9, 6626.2, 6613.33, 6622.45] },
    { x: new Date(1538811000000), y: [6623.48, 6627, 6618.38, 6620.35] },
    { x: new Date(1538812800000), y: [6619.43, 6620.35, 6610.05, 6617.53] }, 
    // Add more 1M data here
  ],
  "6M": [
    { x: new Date(1538778600000), y: [6629.81, 6650.5, 6623.04, 6633.33] },
    { x: new Date(1538780400000), y: [6632.01, 6643.59, 6620, 6630.11] },
  ...
  "Max": [
    ...
    // Add more Max data here
  ],
};

const timeframes = ["1D", "1W", "1M", "6M", "1Y", "5Y", "Max"];

export const QuaterlyCandleStickChart = () => {
