...
const ElitePaymenthalfForm = () => {
  ...
  const handleBillingCycleChange = (e) => {
    ...
    if (value === "Annually") {
      navigate("/elitePaymentPremiumForm");
  ...
  <label class="custom-radio-container">
    ...
    <p class="billingpayment">Most flexible option. Billed half-yearly.</p>
        ...
        <div className="form-rrowelite">
          ...
          <p className="paragraphpremium">Next payment on Dec 29, 2025: Premium plan at regular price — ₹2,000.00.</p></div>
...
export default ElitePaymenthalfForm;