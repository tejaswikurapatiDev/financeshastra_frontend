...
import './Upihalfyearelite.css';
import { RxCross2 } from "react-icons/rx";

const UpihalfyearFormelite = () => {
  ...
  const handleBillingCycleChange = (e) => {
    ...
    if (value === "Annually") {
        navigate("/upiPaymentFormelite");
      } else if (value === "Half-year") {
        navigate("/upihalfyearFormelite");
      }
  };
  ...
  <label>
    <input
      ...
      onClick={() => navigate("/elitePaymentPremiumForm")}
    />
  ...
  <label>
    <input
      ...
      onChange={handleChange}
      onClick={() => navigate("/upiPaymentFormelite")}
    />
    ...
    <p class="billingpayment">Most flexible option. Billed half-yearly.</p>
        ...
        <div className="plan-summary">
          ...
          <div className="form-rrrow">
            <h3>Total</h3>
            <p style={{ color: "black", fontWeight: "bold" }}>₹2,000.00</p>
          </div>
          <div className="paymentparagraph">
            <p className="paragraphpremium">
              Next payment on Dec 29, 2025: Premium plan at regular price — ₹2,000.00.
            </p>
          </div>
...
export default UpihalfyearFormelite;