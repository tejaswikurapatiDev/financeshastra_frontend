  ...
  <label class="custom-radio-container">
    ...
    <p class="billingpayment">Most flexible option. Billed half-yearly.</p>
        ...
        <div className="form-rrow">
          ...
          <p className="paragraphpremium">Next payment on Dec 29, 2025: Premium plan at regular price — ₹5,999.00.</p></div>
...
export default LocalhalfPremiumForm;