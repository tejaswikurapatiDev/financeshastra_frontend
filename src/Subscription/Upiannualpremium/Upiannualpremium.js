...
const UpiPaymentFormpremium = () => {
  ...
  const handleBillingCycleChange = (e) => {
    ...
    if (value === "Annually") {
      navigate("/upiPaymentFormpremium");
    } else if (value === "Half-year") {
      navigate("/upihalfyearpremium");
    }
  };
  ...
  <input
    type="radio"
    className={`custom-radio ${formData.paymentMethod === "upi" ? "active" : ""}`} // Add 'active' class conditionally
    name="paymentMethod"
    value="upi"
    style={{background:"green",color:"white",center:"white"}}
    onChange={handleChange}
    checked={formData.paymentMethod === "upi"}  // Make it checked when the paymentMethod is "upi"
      ...
      <form onSubmit={handleSubmit} className="payment-form">
        <div className="form-section">
          ...
          <div className="form-row">
            ...
            <div className={`form-group ${errors.pan ? "error" : ""}`}>
              <label>PAN*</label>
              <input
                type="text"
                name="pan"
        ...
        <div className="plan-summary">
          ...
          <div className="paymentparagraph">
            <p className="paragraphpremium">
              Next payment on Dec 29, 2025: Premium plan at regular price — ₹7,999.00.
            </p>
          </div>
...
export default UpiPaymentFormpremium;